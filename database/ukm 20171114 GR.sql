...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2017 at 01:32 PM
...
INSERT INTO `pemesanan` (`kode_pemesanan`, `id_user`, `nama_penerima`, `no_telp`, `email`, `alamat_lengkap`, `provinsi`, `kota`, `kode_pos`, `jasa_pengiriman`, `tipe_pengiriman`, `total_harga`, `total_ongkir`, `total_bayar`, `status_kirim`, `tanggal_kirim`, `status_bayar`, `tanggal_bayar`, `kode_resi`, `tanggal_pesan`) VALUES
('171114133123683', 0, 'rita layona', '0856123123123', 'rlayona@binus.edu', 'jalan kebon jeruk raya no 27', 'DKI Jakarta', 'Jakarta Barat', '11530', 'jne', 'CTC', 75000, 46800, 121800, '0', NULL, '0', NULL, NULL, '2017-11-14 19:31:23');
